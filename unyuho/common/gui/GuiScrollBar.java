...
{
	//各自で変えちくり
	private static final ResourceLocation resouce = new ResourceLocation("unyuho","textures/gui/ScrollBar.png");
	private Minecraft mc;

    private IScrollable mainGui;
    ...
    public void drawScrollBar()
    {
        if (this.drawBar)
        {
        	mc.getTextureManager().bindTexture(resouce);
    ...
    private void changeScroll(float newScroll)
    {
        ...
        if(newScroll != currentScroll)
        {
        	...
        	mainGui.scrollPerformed(id, getValue());
        }
    }
