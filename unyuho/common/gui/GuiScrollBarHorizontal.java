...
public class GuiScrollBarHorizontal extends GuiScrollBar
{
    ...
    public GuiScrollBarHorizontal(IScrollable mainGui, int id, int xPosition, int yPosition)
    {
        this(mainGui, id, xPosition, yPosition, 20);
    }

    public GuiScrollBarHorizontal(IScrollable mainGui, int id, int xPosition, int yPositon, int scrollBarSize)
    {
    	this(mainGui, id, xPosition, yPositon, scrollBarSize, 0, scrollBarSize);
    }

    public GuiScrollBarHorizontal(IScrollable mainGui, int id, int xPosition, int yPositon, int scrollBarSize, int minValue, int maxValue)
    {
    	super(mainGui, id, xPosition, yPositon, scrollBarSize, HORIZONTAL_BAR_HEIGHT, minValue, maxValue);
